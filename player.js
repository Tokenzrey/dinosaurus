...
export const player = (() => {
	class Player {
		constructor(params) {
			...
			this.character_ = params.character || "Velociraptor";
			this.params_ = params;
		...
		LoadModel_() {
			...
			// Use the character passed in parameters
			const characterModel = `${this.character_}.fbx`;
			loader.load(characterModel, (fbx) => {
